  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Digital Islamic AUM" value={kpiVal('Digital Islamic AUM', 'RM 12.4B')} status="neutral" />
        <KPICard title="Active Users" value={kpiVal('Active Users', '1.8M')} status="neutral" />
        <KPICard title="Shariah Compliance" value={kpiVal('Shariah Compliance', '100%')} status="neutral" />
        <KPICard title="Products" value={kpiVal('Products', '14')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="App DAU" value={kpiVal('App DAU', '420K')} />
        <KPICard title="Conversion" value={kpiVal('Conversion', '18%')} />
        <KPICard title="Avg Investment" value={kpiVal('Avg Investment', 'RM 8.4K')} />
      </div>
      <Chart
